...
export const getfilterCars = createAsyncThunk('cars/getfilterCars', async (reqobj) => {
  // try {
  console.log(reqobj)

  const response = await axios.get(`/cars?${reqobj.category}${reqobj.color}${reqobj.brand}${reqobj.seats}${reqobj.sort}available=true`
