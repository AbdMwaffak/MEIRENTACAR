    ...
    return (
        <div className='addCar'>
            ...
            <div className='addCarimages'  >
                ...
                <div className='imagMasseg' style={{ display: imagesSquer.length === 0 ? "flex" : "none" }}>
                    no images yet,  add some images

                </div>
                {imagesSquer?.map((image, index) => (
                    <img src={image.URL} className='imgAC' />
                ))}


            </div>
            <Form className='adddcars' noValidate validated={validated} onSubmit={handleSubmit}>

                <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                    <Form.Control
                        type="file"
                        required
                        onChange={imag2OnChange} name='dlimg' accept="image/*" multiple
                        maxLength={4}
                    />
                    <Form.Control.Feedback type="invalid">you have missed this!</Form.Control.Feedback>
        ...
        {/* ///////////// */}
                ...
                <button onClick={handleSubmit} className='addButton'>Submit form</button>
